---
title: Web Servers
description: An overview of servers, including installing development servers, DNS, CDNs, FTP, and more.
---
...
1. [Development Servers](#development-servers)
...
You can also use [homebrew](https://brew.sh/) to [install Apache server](https://medium.com/@crmcmullen/how-to-install-apache-on-macos-10-13-high-sierra-and-10-14-mojave-using-homebrew-3cb6bf6e3cd4)
