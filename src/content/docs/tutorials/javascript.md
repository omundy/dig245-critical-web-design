...
<img src="/images/logos/logo-js.png" width="90" alt="JavaScript logo" />
...
[Data types](https://www.w3schools.com/js/js_variables.asp) | Data type in programming is a category of data that is often represented in a specific way to be distinguished between each other. Data types have two categories: Primitive vs. Non-Primitive
...
[`Math.random()`](https://www.w3schools.com/js/js_math.asp) | Returns a random number between 0 (inclusive), and 1 (exclusive) (e.g. 0–.999...)
...
- [HTML](/html-css/html/), [CSS](/html-css/css/), and [Javascript](/javascript/javascript/) reference sheets
