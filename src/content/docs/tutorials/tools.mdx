...
1. List essential tools for frontend web development and describe their purpose
1. Demonstrate how to install and configure software for a web development environment
</Details>
